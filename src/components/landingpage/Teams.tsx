...
export default function Teams() {
    return (
        <section id="teams" className="mt-14 md:mt-28 mb-12">
            <main>
                <div className="text-center block space-y-4 px-4 md:px-0">
                ...
                <div className="block space-y-9 md:space-y-0 lg:grid lg:grid-cols-4 gap-12 mt-24 mx-12 lg:mx-24">
                    {teams.map((team) => (
                        <div 
                        data-aos="fade-in"
                ...
                {/* OUR MISSION */}
                <div className="mt-12 mx-1 md:mx-12 lg:mx-24">
